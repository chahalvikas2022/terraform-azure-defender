...
```hcl
module "defender" {
  source      = "git::https://github.com/chahalvikas2022/terraform-azure-defender.git"
...
# Examples
For detailed examples on how to use this module, please refer to the '[example](https://github.com/chahalvikas2022/terraform-azure-defender/blob/master/example)' directory within this repository.

# License
This Terraform module is provided under the '[License Name]' License. Please see the [LICENSE](https://github.com/chahalvikas2022/terraform-azure-defender/blob/master/LICENSE) file for more details.
